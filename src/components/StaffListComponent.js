...
class StaffList extends Component {
	constructor(props) {
		...
		this.state = {
			...
			columDefaults: 'col-12 col-md-6 col-lg-4 mt-3',
		};
	}
				...
				<div className='col-12'>
					<Card>
						...
						<CardBody>
							...
							<CardText>Sooss ngày nghỉ còn lại : {staff.annualLeave}</CardText>
	...
	render() {
		const stateLít = this.props.staffs.map((staff) => {
			return (
				<div className={this.state.columDefaults}>
